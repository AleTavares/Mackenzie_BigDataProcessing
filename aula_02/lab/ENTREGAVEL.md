...
1. **Executar o notebook** disponível em `code/aula02_lab.ipynb` — todo o código está pronto
...
|-----------------|---------------------|
| Joins (inner, left, broadcast) | Cruzamento de fontes no pipeline |
| Window Functions (rank, lag) | Análises avançadas na camada Gold |
| UDFs | Transformações customizadas |
| Plano de execução (explain) | Otimização de performance |
