...
mostrar_ajuda() {
    ...
    echo "  base      (padrão) Spark Master + Spark Worker + Jupyter Notebook"
    echo "            Indicado para: Aulas 1, 2 e 3"
    echo ""
    echo "  airflow   Base + Apache Airflow (Webserver + Scheduler)"
    echo "            Indicado para: Aulas 4 e 5"
    echo ""
    echo "  full      Stack completa: Spark + Airflow + Jupyter (autocontido)"
    ...
    echo "  Airflow Webserver: http://localhost:8081  (login: admin/admin)"
...
case "$AMBIENTE" in
    ...
    base)
        echo ""
        echo -e "${BLUE}╔══════════════════════════════════════════════════════════╗${NC}"
        echo -e "${BLUE}║  🚀 Iniciando ambiente BASE (Spark + Jupyter)           ║${NC}"
        echo -e "${BLUE}╚══════════════════════════════════════════════════════════╝${NC}"
        echo ""
